public class LuckyNumbers
{
    ...
    public String getLuckyNumbers() {
        String lucky = "Your lucky numbers are: " + randomIntegerBetween(1, 65) + randomIntegerBetween(1, 65) + randomIntegerBetween(1, 65) + randomIntegerBetween(1, 65) + randomIntegerBetween(1, 65);
        String superBall = "The super ball is: " + randomIntegerBetween(1, 30);

        return lucky + superBall;
    }
}
